 ...
 * @package        Project
 * @subpackage     Model
 * @desc           Task DbTable representation
...
class Project_Model_DbTable_Task extends Zend_Db_Table_Abstract
{
    public function __construct()
    {
        $options = array(
            ...
            'referenceMap' => array(
                'taskStatus' => array( 
                        'columns' => array('tskstu_id'),
                        'refTableClass' => 'Project_Model_DbTable_TaskStatus',
                        'refColumns' => array('tskstu_id'),
