...
class ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
    ...
    protected function _getVersionPanel()
    {
        $panel = '<h4>ZFDebug v'.$this->_version.'</h4>' .
                 '<p>&copy;2008-20011 <a href="http://jokke.dk">Joakim Nyg&aring;rd</a> &amp; <a href="http://www.bangal.de">Andreas Pankratz</a></p>' .
                 '<p>Projet h&eacute;berg&eacute; sur <a href="http://code.google.com/p/zfdebug/">Google Code</a> et d&eacute;velopp&eacute; sous licence BSD<br />' . $this->getLinebreak() .
                 'Contient des images du <a href="http://www.famfamfam.com/lab/icons/silk/">Silk Icon set</a> de Mark James</p>'.
                 '<p>Vous pouvez d&eacute;sactiver temporairement ZFDEBUG en passant ZFDEBUG_DISABLE en param&egrave; GET/POST</p>';
        $panel .= '<h4>Zend Framework '.Zend_Version::VERSION.' / PHP '.phpversion().' avec les extensions:</h4>';
    ...
    protected function _headerOutput() {
        ...
        if (isset($this->_options['css_path'])) {
            $header = '<link rel="stylesheet" type="text/css" href="' . $this->_options['css_path'] . '/zfdebug.css" />' . PHP_EOL;
        }
        else {
            $header = <<<CSS
...
SCRIPT;
        if (isset($this->_options['js_path'])) {
            $header .= '<script language="javascript" type="text/javascript" src="' . $this->_options['js_path'] . '/zfdebug.js" ></script>' . PHP_EOL;
        }
        else {
            $header .= <<<JS
            <script type="text/javascript">
